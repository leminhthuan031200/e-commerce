...
class PostCommentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Cảm ơn đã bình luận bài viết');
        }
        else{
            request()->session()->flash('error','Có gì đó sai, Vui lòng thử lại!!');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($comment){
            ...
            request()->session()->flash('error','Bình luận không tìm thấy');
            return redirect()->back();
        }
    ...
    public function destroy($id)
    {
        ...
        if($comment){
            ...
            if($status){
                ...
                request()->session()->flash('error','Đã xảy ra lỗi khi xóa bình luận bài viết');
            }
            return back();
        }
        else{
