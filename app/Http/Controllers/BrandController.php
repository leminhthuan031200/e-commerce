...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Đã tạo thương hiệu thành công');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Thương hiệu được cập nhật thành công');
        }
        else{
            request()->session()->flash('error','Lỗi. Vui lòng thử lại');
        }
    ...
    public function destroy($id)
    {
        ...
        if($brand){
            $status=$brand->delete();
            if($status){
                request()->session()->flash('success','Đã xóa thương hiệu thành công');
            }
            else{
                request()->session()->flash('error','Lỗi. Vui lòng thử lại');
            }
