...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Đơn vị giao hàng được tạo thành công');
        }
        else{
            request()->session()->flash('error','Lỗi khi tạo đơn vị giao hàng');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Đơn vị giao hàng được cập nhật thành công');
        }
        else{
    ...
    public function destroy($id)
    {
        ...
        if($shipping){
            ...
            request()->session()->flash('error','Không tìn thấy đơn vị giao hàng');
