...
@section('main-content')
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="subject" type="text" id="subject" placeholder="Nhập tiểu đề">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Email :<span>*</span></label>
												<input name="email" type="email" id="email" placeholder="Nhập địa chỉ mail">
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Gọi tôi ngay :</h4>
									<ul>
	...
	<div class="map-section">
		<div id="myMap">
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15704.61226824283!2d105.95292087607052!3d10.249236232887956!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310a82ce5cf7b76b%3A0x112958f2cb033ec5!2zUGjGsOG7nW5nIDIsIFRwLiBWxKluaCBMb25nLCBWxKluaCBMb25nLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1651736096427!5m2!1svi!2s" width="100%" height="100%"  frameborder="0" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
