...
@endsection
@section('title','H2T - FASHION || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
													...
													<!-- Size -->
														...
														<div class="size mt-4">
															...
															<ul>
																...
																<li><a href="#{{$size}}" id="{{$size}}" class="one">{{$size}}</a></li>
																@endforeach
															</ul>
														</div>
													@endif
												...
												@endif
												<p class="availability">Số lượng trong kho : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đằng nhập</a> hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		@endphp --}}
																		<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Tổng thể đánh giá)</span></h4>
																		<span>Số lượng {{$product_detail->getReview->count()}} bình luận</span>
																	</div>
