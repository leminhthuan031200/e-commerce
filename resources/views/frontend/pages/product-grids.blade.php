                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                            ...
                            <div class="col-12">
                                ...
                                <div class="shop-top">
                                    <div class="shop-shorter">
                                        ...
                                        <div class="single-shorter">
                                            <label>Sản xếp theo :</label>
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                <option value="">Mặc đ</option>
                        ...
                        <div class="row">
                            ...
                            @if(count($products)>0)
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Mô tả ngắn</span></a>
                                                    ...
                                                    <div class="product-action-2">
                                                        <a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Thêm vào giả hàng</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                @endforeach
                            @else
                                    <h4 class="text-warning" style="margin:100px auto;">Không có sản phẩm. Cảm ơn</h4>
                            @endif
                                        ...
                                        <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-review">
                                                ...
                                                <div class="quickview-stock">
                                                    @if($product->stock >0)
                                                    <span><i class="fa fa-check-circle-o"></i>Số lượng trong kho: {{$product->stock}}</span>
                                                    @else
                                            ...
                                            <form action="{{route('single-add-to-cart')}}" method="POST">
                                                ...
                                                <div class="add-to-cart">
                                                    <button type="submit" class="btn">Thêm vao giỏ hàng</button>
