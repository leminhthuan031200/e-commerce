...
@section('title','H2T - FASHION || Blog Page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Bài viết của shop</a></li>
                        </ul>
                    </div>
                </div>
            </div>
