...
<div class="card">
  <h6><span class="badge badge-warning right"><b><i class="nav-icon fas fa-address-card"></i></i> THÊM BÀI VIẾT</b></span></h6>
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        ...
        <div class="form-group">
          <label for="tags">Tag bài viết</label>
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--Chọn tag bài viết--</option>
...
<script>
    ...
    $(document).ready(function() {
      $('#summary').summernote({
        placeholder: "Viết tổng quát ngắn.....",
          tabsize: 2,
          height: 100
      });
    });
