...
<div class="card">
    <h5 class="card-header">CHỈNH SỬA VOUCHER</h5>
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="code" placeholder="Nhập mã giãm giá"  value="{{$coupon->code}}" class="form-control">
          @error('code')
          ...
          <div class="form-group">
              ...
              <input id="inputTitle" type="number" name="value" placeholder="Nhập giá trị giảm"  value="{{$coupon->value}}" class="form-control">
              @error('value')
              <span class="text-danger">{{$message}}</span>
              @enderror
          </div>
