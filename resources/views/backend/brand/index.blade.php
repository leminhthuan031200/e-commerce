...
@section('title','H2T-SHOP || Brand Page')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h4><span class="badge badge-warning right"><b><i class="nav-icon fas fa-address-card"></i></i> DANH SÁCH THƯƠNG HIỆU</b></span></h4>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Không tìm thấy thương hiệu !!! Hãy tạo thương hiệu</h6>
        @endif
      </div>
    </div>
</div>
