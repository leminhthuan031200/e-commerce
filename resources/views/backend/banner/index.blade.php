...
@section('main-content')
 <!-- DataTales Example -->
 <h4><span class="badge badge-warning right"><b><i class="nav-icon fas fa-address-card"></i></i> Danh sách banner</b></span></h4>
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm sản phẩm</a>
    </div>
    <div class="card-body">
