...
<div class="card">
  <h4><span class="badge badge-warning right"><b><i class="nav-icon fas fa-address-card"></i></i> CHỈNH SỬA SẢN PHẨM</b></span></h4>
  <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Nhập tên sản phẩm..."  value="{{$product->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="is_featured">Loại sản phẩm</label><br>
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Giái(VND) <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="XL"  @if( in_array( "XL",$data ) ) selected @endif>Rất lớn</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="condition">Loại sản phẩm</label>
