...
<div class="card">
  <h4><span class="badge badge-warning right"><b><i class="nav-icon fas fa-address-card"></i></i> THÊM SẢN PHẨM</b></span></h4>
  <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Tổng quát<span class="text-danger">*</span></label>
        ...
        <div hidden class="form-group">
          <label for="is_featured">Loại</label><br>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Nhập mức giảm giá..."  value="{{old('discount')}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="XL">Rất lơn (XL)</option>
          </select>
        </div>
