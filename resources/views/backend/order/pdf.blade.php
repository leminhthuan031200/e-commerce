...
<style type="text/css">
  ...
  <div class="invoice-header">
    <div class="float-left site-logo">
      <img src="{{asset('storage/photos/images.png')}}" alt="">
    </div>
    <div class="float-right site-address">
      <h4>{{env('APP_NAME')}}</h4>
      <p>{{env('APP_ADDRESS')}}</p>
      <p>Số điện thoại: <a href="tel: 0123456789"> 0123456789</a></p>
      <p>Email: <a href="mailto:h2tshop@gmail.com">h2tshop@gmail.com</a></p>
    </div>
    ...
    <table class="table table-bordered table-stripe">
      <thead>
        <tr>
          ...
          <th scope="col" class="col-3">Sô lượng</th>
      ...
      <tfoot>
        <tr>
          ...
          <th scope="col" class="text-right">Tiền cần thanh toán:</th>
      ...
      @endif --}}
        <tr>
          ...
          @endphp
          <th scope="col" class="text-right ">Giá giao hàng:</th>
