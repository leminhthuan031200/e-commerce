...
<div class="container-fluid">
    ...
    <div class="card">
      <div class="card-header">
         <h2 class="card-title "><span class="badge badge-warning right"><b><i class="nav-icon fas fa-tachometer-alt"></i> NHÀ CỦA TÔI</b></span></h2>
      </div>
      <div class="card-body">
    ...
    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Nhà của tôi</h1>
    </div>
    <div class="row">
      @php
          $orders=DB::table('orders')->where('user_id',auth()->user()->id)->paginate(10);
      ...
      <div class="col-xl-12 col-lg-12">
        <table class="table table-bordered" id="order-dataTable"id="table" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>S.N.</th>
              <th>Sô đặt hàng</th>
