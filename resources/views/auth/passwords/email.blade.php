              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4" style="color: black">Chỉ cần nhập địa chỉ email của bạn vào bên dưới và chúng tôi sẽ gửi cho bạn một liên kết để đặt lại mật khẩu của bạn!</p>
                  </div>
                    @if (session('status'))
                    ...
                    @endif
                  <form class="user"  method="POST" action="{{ route('password.forgot') }}">
                    @csrf
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{route('login')}}">Bạn đã có tài khoản? Đăng nhập!</a>
                  </div>
                </div>
              </div>
            </div>
